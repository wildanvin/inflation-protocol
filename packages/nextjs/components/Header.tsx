      ...
      <div className="navbar-start w-auto lg:w-1/2">
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6">
          <div className="flex relative w-10 h-10">
            <Image alt="INF logo" className="cursor-pointer" fill src="/infLogo.svg" />
          </div>
          <div className="flex flex-col">
            <span className="font-bold leading-tight">Inflation Protocol</span>
            <span className="text-xs">For Colombian Pesos</span>
          </div>
        </Link>
